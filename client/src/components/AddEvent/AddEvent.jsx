  ...
  return(
    <div className="container mt-3">
            ...
            <div className="row py-2">
              ...
              <div className="col-9">
                <FormControl variant="standard" sx={{ m: 0,p:0, minWidth: 200 }}>
                  <InputLabel id="demo-simple-select-standard-label">Select Members</InputLabel>
                  <Select
                  ...
                  >
                    ...
                    </MenuItem>
                    {
                      friendList.map((friend, index) => {
                        return (<MenuItem key={index} value={friend}>{friend}</MenuItem>);
                      })
                    }
                  </Select>
                </FormControl>
